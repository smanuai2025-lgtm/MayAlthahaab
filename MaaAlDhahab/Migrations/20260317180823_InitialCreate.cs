        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubtitleEn = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    ImageUrl = table.Column<string>(type: "TEXT", nullable: true),
                    LinkUrl = table.Column<string>(type: "TEXT", nullable: true),
                    ButtonTextAr = table.Column<string>(type: "TEXT", nullable: true),
                    ButtonTextEn = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DescriptionAr = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    DescriptionEn = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    DiscountType = table.Column<string>(type: "TEXT", nullable: false),
                    DiscountValue = table.Column<decimal>(type: "decimal(10,3)", nullable: false),
                    MinOrderAmount = table.Column<decimal>(type: "decimal(10,3)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "TEXT", nullable: false),
                    FullNameAr = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    FullNameEn = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceKWD = table.Column<decimal>(type: "decimal(10,3)", nullable: false),
                    OriginalPriceKWD = table.Column<decimal>(type: "decimal(10,3)", nullable: true),
                    ...
                    ScentNotesJson = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Block = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    ...
                    AddressNotes = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    SubTotal = table.Column<decimal>(type: "decimal(10,3)", nullable: false),
                    DeliveryFee = table.Column<decimal>(type: "decimal(10,3)", nullable: false),
